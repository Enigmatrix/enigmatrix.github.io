    ...
    <HomeSection class="whoami" cmd="whoami">
      <div class="flex flex-col md:flex-row items-center justify-center">
        ...
        <div class="p-4 flex flex-col md:block items-center">
          ...
          <span class="text-lg">
              <p class="mb-2 leading-none">Student of NUS High School. I have a <a class="text-orange hover:text-orange-dark underline font-bold" href="">blog</a> about my life and interests.</p>
            <p
